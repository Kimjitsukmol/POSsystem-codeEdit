...
// const showReceiptBtn = document.getElementById("receipt");
...
//     // Loop ใบเสร็จทั้งหมด
//    receiptHistory.slice().reverse().forEach((receipt, index) => {
//     bill.innerHTML += `
//         <div style="border:1px solid #ccc; margin:10px 0; padding:10px; border-radius:10px; background:#fff;">
//             <div class="bill-head">ร้านเจ้พิน ขายของชำ (ใบที่ ${index + 1})</div>
//             <div class="bill-detail"><div>เวลา:</div><div>${receipt.time}</div></div>
//             <div class="bill-detail"><div>วันที่:</div><div>${receipt.date}</div></div>
//             <div class="bill-detail"><div>สินค้า</div><div>จำนวน</div><div>ราคารวม</div></div>
//     `;
...
//     } else {
//         bill.innerHTML += `
//             <div class="bill-detail" style="color:red;">
//                 ไม่มีรายการสินค้าในใบเสร็จนี้
//             </div>
//         `;
//     }

//     bill.innerHTML += `
//         <div class="bill-detail"><div style="font-weight:bold;">รวมทั้งสิ้น</div><div style="font-weight:bold;">${receipt.total}</div></div>
//         <div class="bill-detail"><div>รับเงิน</div><div>${receipt.cashReceived}</div></div>
//         <div class="bill-detail"><div>เงินทอน</div><div>${receipt.change}</div></div>
//         <div style="text-align:center; font-size:1.2vw; padding-top:1vw;">--- ขอบคุณค่ะ ---</div>
//         </div>
//     `;
// });
